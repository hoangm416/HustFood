...
exports.validateMyRestaurantRequest = [
    (0, express_validator_1.body)("restaurantName").notEmpty().withMessage("Tên nhà hàng được yêu cầu"),
    (0, express_validator_1.body)("city").notEmpty().withMessage("Tên thành phố được yêu cầu"),
    (0, express_validator_1.body)("country").notEmpty().withMessage("Tên thành phố được yêu cầu"),
    ...
    (0, express_validator_1.body)("menuItems.*.name").notEmpty().withMessage("Các món ăn trong thực đơn đã được yêu cầu"),
...
exports.validateMyUserRequest = [
    (0, express_validator_1.body)("name").isString().notEmpty().withMessage("Họ tên phải là một chuỗi ký tự"),
    (0, express_validator_1.body)("addressLine1")
        .isString()
        .notEmpty()
        .withMessage("Địa chỉ phải là một chuỗi ký tự"),
    (0, express_validator_1.body)("city").isString().notEmpty().withMessage("tên của Quận/Huyện phải là một chuỗi ký tự"),
    (0, express_validator_1.body)("country").isString().notEmpty().withMessage("Tên của Tỉnh/Thành phố phỉa là một chuỗi ký tự"),
    handleValidationErrors,
];
